        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="row d-flex justify-content-center">
                    <!-- Cards - Fixed height added -->
                    <div class="col-md-3 col-lg-3 col-xlg-3 mb-4">
                        <a href="{{ route('restaurants.index') }}" class="btn btn-link text-decoration-none w-100 h-100">
                            <div class="box bg-warning text-center card card-hover" style="height: 150px; display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <div class="col-md-3 col-lg-3 col-xlg-3 mb-4">
                        <a href="{{ route('users.index') }}" class="btn btn-link text-decoration-none w-100 h-100">
                            <div class="box bg-danger text-center card card-hover" style="height: 150px; display: flex; flex-direction: column; justify-content: center;">
                                <h1 class="font-light text-white">
