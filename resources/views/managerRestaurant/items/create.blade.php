            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('managerRestaurant.items.index') }}" class="btn btn-secondary mb-3">Retour à la liste</a>

                        <form action="{{ route('managerRestaurant.items.store') }}" method="POST">
                            @csrf
                            <div class="mb-3">
