...
@section('main')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form class="form-horizontal" action="{{ route('managerRestaurant.items.update', $item->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="card-body">
                        ...
                        <div class="border-top">
                            <div class="card-body text-end">
                                <a href="{{ route('managerRestaurant.items.index') }}" class="btn btn-secondary">Retour</a>
